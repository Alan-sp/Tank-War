...
namespace PolygonUtil{
    ...
    double num_rep1(node x, node y) {
		return x.x * y.x + x.y * y.y;
	}
    node Support(Shape ts1, Shape ts2, node fstd) {
    ...
    double Q_len(node nd, node c1, node c2) {
